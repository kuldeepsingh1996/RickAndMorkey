...
class RMCharcterCollectionViewCell: UICollectionViewCell {
    
    static let reuseIdentifier = "RMCharcterCollectionViewCell"
...
//    MARK:Init
    ...
    public func configure(with viewModel:RMCharcterCollectionViewCellViewModel) {
        nameLabel.text = viewModel.charcterName
        statusLabel.text = viewModel.charcterStausText
